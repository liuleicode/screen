...
if __name__ == "__main__":
    ...
    while (True):
        ...
        data1 = (result2[13],result2[0],"","",result2[1],result2[8],result2[4],result2[5],result2[7],result2[9],result2[2],result2[3],result2[6], 1)
        data2 = (result1[13],result1[0],"","",result1[1],result1[8],result1[4],result1[5],result1[7],result1[9],result1[2],result1[3],result1[6], 2)
